...
export default function Pharmacie() {
  ...
  const columns = [
    ...
    },
    {
        ...
        key: "photos",
        render: (photos) => (
          <img src={photos} alt="Pharmacy" style={{ width: "50px", height: "50px" }} />
        ),
      },
    {
      title: "zone",
      ...
      render: (_, record) => (
        <Space size="middle">
          <Popconfirm title="Sure to update">
            <Button style={{ backgroundColor: "green", color: "white" }} variant="outlined">Update</Button>
          </Popconfirm>
          <Popconfirm title="Sure to delete?" onConfirm={() => deleteUser(record.id)}>
            <Button style={{ backgroundColor: "blue", color: "white" }} variant="outlined">Delete</Button>
          </Popconfirm>
        </Space>
      ),
      key: "action",
