...
export default function Zone() {
  ...
  const onSubmit = (event) => {
    ...
    if (!d.nom) {
     ...
     console.log(d);
     axios.post("/api/controller/zones/save",d)
     .then(() => {
       forceUpdate(); // rel
     });
    }
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="middle">
          <Button variant="outlined" style={{ backgroundColor:"green", color: "white" }} onClick={() => handleUpdate(record)}>
            Update
          </Button>
          ...
          >
            <Button variant="outlined" style={{ backgroundColor:"blue", color: "white" }}> Delete</Button>
